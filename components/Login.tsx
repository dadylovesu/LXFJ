      ...
      <div className="w-full max-w-xl px-8">
        <div className="bg-cine-dark border border-cine-border rounded-lg p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-200 text-sm font-mono">请登录以继续</p>
          </div>

          {/* 登录表单 */}
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="username" className="block text-lg text-zinc-200 font-mono uppercase tracking-wider mb-2">
                用户名
              </label>
              <input
                id="username"
            ...
            <div>
              <label htmlFor="password" className="block text-lg text-zinc-200 font-mono uppercase tracking-wider mb-2">
                密码
              </label>
              <input
                id="password"
