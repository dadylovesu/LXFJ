...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-zinc-800/80 hover:bg-zinc-700 text-zinc-100 border border-zinc-700/50 backdrop-blur-sm",
    secondary: "bg-transparent text-zinc-400 hover:text-zinc-100 border border-dashed border-zinc-800 hover:border-zinc-600",
  ...
  const sizes = {
    ...
    md: "text-[13px] px-4 py-2 rounded-[2px]",
