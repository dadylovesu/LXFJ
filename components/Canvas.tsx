    ...
    <div className="flex flex-col h-full bg-black relative selection:bg-cine-accent selection:text-black">
      ...
      <div className="flex-1 relative overflow-hidden bg-[#0a0a0a]">
        {images.length === 0 ? (
            ...
            <>
                {viewMode === 'workflow' && (
                    <div className="w-full h-full overflow-hidden cursor-grab active:cursor-grabbing bg-[#050505]" ref={containerRef} onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp} onWheel={handleWheel}>
                         ...
                         <div className="absolute origin-top-left transition-transform duration-75 ease-out will-change-transform" style={{ transform: `translate(${pan.x}px, ${pan.y}px) scale(${scale})` }}>
                             {images.map(img => {
                                 if (img.parentId) {
